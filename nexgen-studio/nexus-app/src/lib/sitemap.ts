...
export const PUBLIC_SITEMAP: SitemapLink[] = [
  ...
  { href: '/creators', label: 'Creators', description: 'AI influencer personas and identity management.' },
  { href: '/calendar', label: 'Calendar', description: 'Publishing calendar and content queues.' },
  { href: '/socials', label: 'Socials', description: 'Connected social platforms.' },
